...
def mnist_noniid_pro(dataset, num_users):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
    ...
    # for i in range(70, num_users):
    #     dict_users[i] = set(np.random.choice(idx_4_9, 600, replace=False))
...
if __name__ == '__main__':
    ...
    num = 100
    d = mnist_noniid_pro(dataset_train, num)
